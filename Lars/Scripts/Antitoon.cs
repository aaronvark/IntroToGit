...
public class Antitoon : Enemy, IDamageable
{
    public int damage
    {
        get
        {
            return GameObject.Find("RayFist").GetComponent<RayFist>().damage;
        }
        set
        {
            damage = value;
    ...
    protected override void OnAwake()
    {
        ...
        maxHealth = 1;
        health = maxHealth;
        defaultFlip = spriteRend.flipX;
    }

    protected override void OnStart()
    {
        currentMoveSpeed = spriteRend.flipX ? maxMoveSpeed : -maxMoveSpeed;
    }
